...
//This code is for Jira api test
//Jira uses key-value and cookie based authentication 
//In this we have used session filter, path param, query param.
//And also used multi-part method for adding attachments like files to api
...
public class SessionfilterPathparamQueryparam {
